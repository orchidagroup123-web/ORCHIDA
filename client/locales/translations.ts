export const translations = {
  en: {
    ...
    heroSubtitle: 'Leading innovation across agriculture, mining, trade, livestock, fisheries, and infrastructure',
    whoWeAre: 'Who We Are',
    readMore: 'Read More',
    ...
    pageInDevelopment: 'This page is currently in development. Let us know what you\'d like to see here!'
  },
  ar: {
    // Header & Navigation
    home: 'الرئيسية',
    ...
    heroSubtitle: 'الريادة والابتكار عبر الزراعة والتعدين والتجارة والثروة الحيوانية والسمكية والبنية التحتية',
    whoWeAre: 'من نحن',
    ...
    // Placeholder Pages
    comingSoon: 'قريباً',
    pageInDevelopment: 'هذه الصفحة قيد التطوير حالياً. أخبرنا بما تود رؤيته هنا!'
  }
};

export function getTranslation(language: 'en' | 'ar', key: keyof typeof translations.en): string {
