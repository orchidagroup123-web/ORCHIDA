...
export const hierarchicalSectorsV2: MainSector[] = [
  // ========== MINING (TOP/APEX) ==========
  {
    ...
    shortDescriptionEn:
      "Exploration and processing of mineral wealth with advanced technologies",
    iconEmoji: "⛏️",
    image:
      "https://images.unsplash.com/photo-1581092162562-40038f56543a?w=1200&h=800&fit=crop",
    level: "primary",
    position: "apex",
  ...
  // ========== AGRICULTURE (RIGHT) ==========
  {
    ...
    shortDescriptionEn:
      "Sustainable solutions for food security and resource development",
    iconEmoji: "🌾",
    image:
  ...
  // ========== INFRASTRUCTURE (LEFT) ==========
  {
    ...
    shortDescriptionEn:
      "Designing and executing infrastructure projects that support growth",
    iconEmoji: "🏗️",
    image:
      "https://images.unsplash.com/photo-1581092162562-40038f56543a?w=1200&h=800&fit=crop",
    level: "primary",
