...
export const sectorsData: Sector[] = [
  {
    ...
    nameAr: "قطاع الصحة الزراعية",
    nameEn: "Agricultural Health",
    titleAr: "ريادة الحلول الزراعية المستدامة",
    titleEn: "Leadership in Sustainable Agricultural Solutions",
    descriptionAr: "حلول زراعية متقدمة وآمنة",
    descriptionEn: "Advanced and safe agricultural solutions",
    iconEmoji: "🌾",
    image:
      "https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=600&h=400&fit=crop",
    color: "from-green-500 to-green-700",
    fullContentAr: `نحن في مجموعة أوركيد نؤمن بأن الأمن الغذائي يبدأ من حماية الأرض والمحصول. يتخصص قطاع الصحة الزراعية لدينا في توفير أحدث التقنيات الوقائية، من مبيدات آمنة وأسمدة حيوية ومغذيات متطورة، مصممة لرفع كفاءة الإنتاج الزراعي مع الحفاظ على التوازن البيئي. نحن شريك المزارع في مواجهة التحديات المناخية وضمان حصاد عالي الجودة.`,
    fullContentEn: `We at Orchida Group believe that food security begins with protecting the land and crops. Our Agricultural Health sector specializes in providing the latest preventive technologies, from safe pesticides to bio-fertilizers and advanced nutrients, designed to enhance agricultural production efficiency while preserving environmental balance. We are the farmer's partner in facing climate challenges and ensuring high-quality harvests.`,
  },
  {
    id: "mining",
    nameAr: "قطاع التعدين",
